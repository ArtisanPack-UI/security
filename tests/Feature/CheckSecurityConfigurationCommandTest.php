...
{
    #[Test]
    public function it_shows_no_errors_or_warnings_for_a_valid_configuration(): void
    {
    ...
    #[Test]
    public function it_shows_an_error_when_debug_is_enabled_in_production(): void
    {
    ...
    #[Test]
    public function it_shows_a_warning_when_two_factor_is_disabled_in_production(): void
    {
        $this->app->detectEnvironment(fn () => 'production');
    ...
    #[Test]
    public function it_supports_category_filtering(): void
    {
        Config::set('app.debug', false);
        Config::set('artisanpack.security.encrypt', true);
    ...
    #[Test]
    public function it_supports_strict_mode(): void
    {
        $this->app->detectEnvironment(fn () => 'production');
