...
test('escape html', function (): void {
    expect(escHtml('<p>This is a paragraph</p>'))->toEqual('&lt;p&gt;This is a paragraph&lt;/p&gt;');
});

test('escape url', function (): void {
    expect(escUrl('https://ArtisanPackUIcms.com/this is a url'))->toEqual('https%3A%2F%2FArtisanPackUIcms.com%2Fthis%20is%20a%20url')
        ->and(escUrl('https://ArtisanPackUIcms.com'))->toEqual('https%3A%2F%2FArtisanPackUIcms.com');
});

test('escaping attr', function (): void {
    expect(escAttr('<p>This is a test</p>'))->toEqual('&lt;p&gt;This&#x20;is&#x20;a&#x20;test&lt;&#x2F;p&gt;');
});

test('escaping js', function (): void {
    expect(escJs('<script>
        let testVar = "";
...
test('escaping css', function (): void {
...
test('escaping kses', function (): void {
