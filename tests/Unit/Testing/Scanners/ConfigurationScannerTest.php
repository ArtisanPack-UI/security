...
{
    protected ConfigurationScanner $scanner;
    ...
    {
        $this->assertInstanceOf(ConfigurationScanner::class, $this->scanner);
    }
    ...
    {
        $this->assertEquals('Configuration Scanner', $this->scanner->getName());
    }
    ...
    public function test_scanner_description(): void
    {
        ...
        $this->assertStringContainsString('configuration', strtolower($description));
    }

    public function test_all_findings_have_valid_severity(): void
    {
        $findings = $this->scanner->scan();
